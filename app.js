...
//Shapes for pieces as they rotate
    ...
    function freezePiece() {
        if(activePiece.some(index => squares[currentPosition + index + width].classList.contains("taken")) || activePiece.some(index => squares[currentPosition + index + width].classList.contains("bottom-taken"))) {
    ...
    const nextPiecesUp = [
        [1, 2, miniGridWidth+1, miniGridWidth*2+1], //lPiece 
        [miniGridWidth, miniGridWidth+1, miniGridWidth+2, miniGridWidth*2+1], //tPiece
        [1, 2, miniGridWidth+2, miniGridWidth*2+2], //jPiece
        [miniGridWidth+1, miniGridWidth+2, miniGridWidth*2+2, miniGridWidth*2+3], //zPiece
        [miniGridWidth+1 , miniGridWidth+2, miniGridWidth*2+1, miniGridWidth*2+2], //oPiece
        [1,miniGridWidth+1,miniGridWidth*2+1, miniGridWidth*3+1] //iPiece
    ]
